...
$rep_text = "";
if(hexdec($start_code) < 711140) {
  $condition = 0;
  $graph_text = ' as indicated in the figure below';
} else {
  $condition = 1;
...
<div id="replication">
  ...
  <input type="hidden" name="time_replication_started" id="time_replication_started"/>
    <p>A large pharmaceutical company has recently developed a new drug to boost peoples' immune function. It reports that trials it conducted demonstrated a drop in occurrence of the common cold<?php if ($condition == 0) {
      echo $graph_text;
    }?>. It intends to market the new drug as soon as next winter, following FDA approval.</p>
...
<h2 style="margin-top: 20px">Final Questions</h2>  
