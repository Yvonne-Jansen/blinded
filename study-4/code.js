...
function finishedFinalQuestions() {
    if (!validateRadioButtons("test_question")) {
        alert("Your answer for the first question is missing.");
        return false;
    } else if (!document.forms["answers"]["attention_people"].value){
        alert("Please enter a number for the second question.");
        return false;
    } else  {

        document.getElementById("test_and_comments").style.display = 'none';
...
function validateComments() {
    if (!validateRadioButtons("belief_in_science")) {
        alert("Your answer for the first question is missing.");
        return false;
    } else if (!validateRadioButtons("belief_in_drug")) {
        alert("Your answer for the second question is missing.");
        return false;
    } else {
        return true;
    }
...
//     return 'Are you sure? Reloading this page results in exclusion from the study.';
// };