...
$output_string = "";
if ($correct_trial) {
    $output_string = 'To receive payment, please copy the code shown below in the corresponding field on the Crowdflower website.</div><h2>' . $code . '</h2>';
} else {
...
if ($reloader_cheat) {
    $output_string = "However our data indicate that you reloaded the page and circumvented our reload test. As indicated in the instructions for this task, any attempt to reload or to perform the task twice leads to exclusion from the study.";
} else if ($duplicate_wrong) {
    $output_string = "However our data indicate that you previously completed this task and that you then failed to answer the final question correctly. As indicated in the instructions for this task, it can only be completed once and any attempt to reload or to perform the task twice leads to exclusion from the study.";
}  
?>
<html>
    <head>
